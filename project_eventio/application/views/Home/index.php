...
<body>
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          if ($this->session->has_userdata('USERNAME')) {
            ...
            echo '<li?><a class="nav-link scrollto" href="' . base_url('index.php/login/logout') . '">Logout</a></li>';
          } else {
          ?>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to <span>Eventio</span></h1>
      <h2>Hello we are Eventio Unique concept and Client satisfaction is our top priority !</h2>
      <?php
      if ($this->session->userdata('ROLE') == 'administrator') {
      ?>
        <a href="<?php echo base_url('index.php/kegiatan') ?>" class="btn-get-started scrollto">Backend</a>
      <?php
      }
      ?>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>About Us</h3>
            <p>
              Eventio adalah sebuah event organizer yang dibentuk oleh para performer dan konten creator sehingga Eventio memiliki kelebihan yaitu passion pertunjukan dan penyusunan strategi acara.
              Pengalaman kami di dunia pertunjukan memberikan kami pengetahuan lebih akan seluk beluk sebuah acara,
              sebagai contoh hal ini sangat bermanfaat dalam penghematan pengeluaran biaya suatu acara / yang kami tawarkan kepada klien kami.
              Dengan tim yang terdiri dari pemuda kreatif dengan karakter memiliki imajinasi dan daya kerja yang tinggi dan cepat, membuat kami selalu dipercayai oleh beberapa produk bahkan institusi untuk mengadakan acara nya.
              Kami telah memiliki PT. dalam bidang event organizer & Pembuatan Film. Lewat PT Suara Sanara Juara , kami membuktikan bahwa kami serius berada dalam bidang acara bukan perusahaan abal abal yang tidak jelas / atau panitia bentukan baru.
            </p>
          </div>
        </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  Layanan, suara, sistem cahaya yang hebat yang disediakan oleh Eventio, penanggung jawab yang sangat baik dan profesional
            ...
            <div class="info-wrap">
              <div class="row">
                <div class="col-lg-4 info">
                  ...
                  <h4>Location:</h4>
                  <p>Jalan Lenteng Agung Raya No.20<br>DKI Jakarta 12640</p>
                </div>

                <div class="col-lg-4 info mt-4 mt-lg-0">
                  <i class="bi bi-envelope"></i>
                  <h4>Email:</h4>
                  <p>infoio@event.io.id<br>eventio@event.io.id</p>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              DKI Jakarta 12640 <br>
              <strong>Phone:</strong> (021) 7863191<br>
              <strong>Email:</strong> eventio@event.io.id<br>
            </p>
          </div>
